# LC01 — Problem Statement: Potable

**ATA Reference:** 38-10  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 38 — Water Waste  
**Scope:** Potable requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Potable** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-38-10-001 | Potable Requirements | OPEN | 100 |
