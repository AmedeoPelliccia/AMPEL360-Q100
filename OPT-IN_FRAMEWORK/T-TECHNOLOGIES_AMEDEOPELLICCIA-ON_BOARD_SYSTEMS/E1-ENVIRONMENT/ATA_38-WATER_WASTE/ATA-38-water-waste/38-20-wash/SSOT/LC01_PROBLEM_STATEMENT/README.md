# LC01 — Problem Statement: Wash

**ATA Reference:** 38-20  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 38 — Water Waste  
**Scope:** Wash requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Wash** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-38-20-001 | Wash Requirements | OPEN | 100 |
