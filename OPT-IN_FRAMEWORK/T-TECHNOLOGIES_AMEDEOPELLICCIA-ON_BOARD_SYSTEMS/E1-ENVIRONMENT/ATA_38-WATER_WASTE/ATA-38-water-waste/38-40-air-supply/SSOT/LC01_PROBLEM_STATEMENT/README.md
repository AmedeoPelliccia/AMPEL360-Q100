# LC01 — Problem Statement: Air Supply

**ATA Reference:** 38-40  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 38 — Water Waste  
**Scope:** Air Supply requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Air Supply** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-38-40-001 | Air Supply Requirements | OPEN | 100 |
