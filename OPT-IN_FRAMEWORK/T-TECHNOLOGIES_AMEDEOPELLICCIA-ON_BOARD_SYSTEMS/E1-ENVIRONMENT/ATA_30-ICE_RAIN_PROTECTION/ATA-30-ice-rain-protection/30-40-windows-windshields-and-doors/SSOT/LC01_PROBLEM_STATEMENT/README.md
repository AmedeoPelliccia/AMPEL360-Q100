# LC01 — Problem Statement: Windows Windshields and Doors

**ATA Reference:** 30-40  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 30 — Ice Rain Protection  
**Scope:** Windows Windshields and Doors requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Windows Windshields and Doors** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-30-40-001 | Windows Windshields and Doors Requirements | OPEN | 100 |
