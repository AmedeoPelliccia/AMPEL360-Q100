# LC01 — Problem Statement: Propellers Rotors

**ATA Reference:** 30-60  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 30 — Ice Rain Protection  
**Scope:** Propellers Rotors requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Propellers Rotors** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-30-60-001 | Propellers Rotors Requirements | OPEN | 100 |
