# LC01 — Problem Statement: Pitot and Static

**ATA Reference:** 30-30  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 30 — Ice Rain Protection  
**Scope:** Pitot and Static requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Pitot and Static** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-30-30-001 | Pitot and Static Requirements | OPEN | 100 |
