# LC01 — Problem Statement: Detection

**ATA Reference:** 30-80  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 30 — Ice Rain Protection  
**Scope:** Detection requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Detection** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-30-80-001 | Detection Requirements | OPEN | 100 |
