# LC01 — Problem Statement: Antennas and Radomes

**ATA Reference:** 30-50  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 30 — Ice Rain Protection  
**Scope:** Antennas and Radomes requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Antennas and Radomes** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-30-50-001 | Antennas and Radomes Requirements | OPEN | 100 |
