# LC01 — Problem Statement: Passenger

**ATA Reference:** 35-20  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 35 — Oxygen  
**Scope:** Passenger requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Passenger** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-35-20-001 | Passenger Requirements | OPEN | 100 |
