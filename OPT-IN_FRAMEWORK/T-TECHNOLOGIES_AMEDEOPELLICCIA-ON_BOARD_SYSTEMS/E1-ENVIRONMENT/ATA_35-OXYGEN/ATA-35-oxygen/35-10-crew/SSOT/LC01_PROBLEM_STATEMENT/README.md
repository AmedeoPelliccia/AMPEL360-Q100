# LC01 — Problem Statement: Crew

**ATA Reference:** 35-10  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 35 — Oxygen  
**Scope:** Crew requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Crew** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-35-10-001 | Crew Requirements | OPEN | 100 |
