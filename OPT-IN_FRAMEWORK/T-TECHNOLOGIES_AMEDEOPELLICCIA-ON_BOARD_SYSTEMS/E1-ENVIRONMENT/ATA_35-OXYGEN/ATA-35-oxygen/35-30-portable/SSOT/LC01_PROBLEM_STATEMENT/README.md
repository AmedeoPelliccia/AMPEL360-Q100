# LC01 — Problem Statement: Portable

**ATA Reference:** 35-30  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 35 — Oxygen  
**Scope:** Portable requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Portable** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-35-30-001 | Portable Requirements | OPEN | 100 |
