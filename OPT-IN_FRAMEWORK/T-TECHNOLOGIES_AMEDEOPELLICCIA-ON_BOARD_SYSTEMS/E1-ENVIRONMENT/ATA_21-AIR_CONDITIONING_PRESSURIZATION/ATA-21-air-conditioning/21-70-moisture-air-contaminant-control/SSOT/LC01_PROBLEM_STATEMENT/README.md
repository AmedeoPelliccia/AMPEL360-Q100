# LC01 — Problem Statement: Moisture Air Contaminant Control

**ATA Reference:** 21-70  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 21 — Air Conditioning Pressurization  
**Scope:** Moisture Air Contaminant Control requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Moisture Air Contaminant Control** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-21-70-001 | Moisture Air Contaminant Control Requirements | OPEN | 100 |
