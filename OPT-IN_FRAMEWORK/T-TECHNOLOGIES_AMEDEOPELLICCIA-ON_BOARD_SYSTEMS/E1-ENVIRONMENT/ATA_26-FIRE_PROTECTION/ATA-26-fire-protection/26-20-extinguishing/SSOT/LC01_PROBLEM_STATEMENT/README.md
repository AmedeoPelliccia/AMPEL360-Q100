# LC01 — Problem Statement: Extinguishing

**ATA Reference:** 26-20  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 26 — Fire Protection  
**Scope:** Extinguishing requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Extinguishing** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-26-20-001 | Extinguishing Requirements | OPEN | 100 |
