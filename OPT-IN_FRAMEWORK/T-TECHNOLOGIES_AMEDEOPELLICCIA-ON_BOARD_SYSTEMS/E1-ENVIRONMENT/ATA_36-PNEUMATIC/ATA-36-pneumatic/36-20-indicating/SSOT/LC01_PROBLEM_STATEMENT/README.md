# LC01 — Problem Statement: Indicating

**ATA Reference:** 36-20  
**OPT-IN Axis:** T-TECHNOLOGIES / E1-ENVIRONMENT  
**Parent System:** ATA 36 — Pneumatic  
**Scope:** Indicating requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Indicating** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-36-20-001 | Indicating Requirements | OPEN | 100 |
