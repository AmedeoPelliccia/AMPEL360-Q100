...
This LC01 node orchestrates uncertainty resolution for **Engine** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-49-20-001 | Engine Requirements | OPEN | 100 |
