...
This LC01 node orchestrates uncertainty resolution for **Oil** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-49-90-001 | Oil Requirements | OPEN | 100 |
