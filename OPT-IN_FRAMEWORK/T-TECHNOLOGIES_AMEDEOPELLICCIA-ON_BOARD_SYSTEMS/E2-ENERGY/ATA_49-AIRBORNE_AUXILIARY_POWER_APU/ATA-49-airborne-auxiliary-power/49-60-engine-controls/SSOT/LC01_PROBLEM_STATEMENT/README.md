# LC01 — Problem Statement: Engine Controls

**ATA Reference:** 49-60  
**OPT-IN Axis:** T-TECHNOLOGIES / E2-ENERGY  
**Parent System:** ATA 49 — Airborne Auxiliary Power  
**Scope:** Engine Controls

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Engine Controls** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-49-60-001 | Engine Controls Requirements | OPEN | 100 |
