# LC01 — Problem Statement: Dc Generation
...
This LC01 node orchestrates uncertainty resolution for **Dc Generation** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-24-30-001 | Dc Generation Requirements | OPEN | 100 |
