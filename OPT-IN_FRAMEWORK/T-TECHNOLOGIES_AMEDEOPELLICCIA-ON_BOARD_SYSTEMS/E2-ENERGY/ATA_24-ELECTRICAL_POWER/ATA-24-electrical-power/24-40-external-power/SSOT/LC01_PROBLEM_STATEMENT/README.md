# LC01 — Problem Statement: External Power

**ATA Reference:** 24-40  
**OPT-IN Axis:** T-TECHNOLOGIES / E2-ENERGY  
**Parent System:** ATA 24 — Electrical Power  
**Scope:** External Power

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **External Power** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-24-40-001 | External Power Requirements | OPEN | 100 |
