# LC01 — Problem Statement: Ac Generation
...
This LC01 node orchestrates uncertainty resolution for **Ac Generation** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-24-20-001 | Ac Generation Requirements | OPEN | 100 |
