# LC01 — Problem Statement: Integrated Automatic

**ATA Reference:** 23-80  
**OPT-IN Axis:** T-TECHNOLOGIES / C1-COMMS  
**Parent System:** ATA 23 — Communications  
**Scope:** Integrated Automatic

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Integrated Automatic** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-23-80-001 | Integrated Automatic Requirements | OPEN | 100 |
