# LC01 — Problem Statement: Static Discharging

**ATA Reference:** 23-60  
**OPT-IN Axis:** T-TECHNOLOGIES / C1-COMMS  
**Parent System:** ATA 23 — Communications  
**Scope:** Static Discharging

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Static Discharging** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-23-60-001 | Static Discharging Requirements | OPEN | 100 |
