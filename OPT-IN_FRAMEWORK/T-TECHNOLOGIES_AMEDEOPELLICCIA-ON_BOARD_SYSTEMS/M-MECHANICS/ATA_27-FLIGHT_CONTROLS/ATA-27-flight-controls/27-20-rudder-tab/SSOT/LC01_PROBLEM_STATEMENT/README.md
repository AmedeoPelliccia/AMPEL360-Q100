# LC01 — Problem Statement: Rudder Tab

**ATA Reference:** 27-20  
**OPT-IN Axis:** T-TECHNOLOGIES  
**Parent System:** ATA 27 — Flight Controls  
**Scope:** Rudder Tab requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Rudder Tab** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-27-20-001 | Rudder Tab Requirements | OPEN | 100 |
