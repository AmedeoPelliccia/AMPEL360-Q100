# LC01 — Problem Statement: Supplementary Gear

**ATA Reference:** 32-70  
**OPT-IN Axis:** T-TECHNOLOGIES  
**Parent System:** ATA 32 — Landing Gear  
**Scope:** Supplementary Gear requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Supplementary Gear** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-32-70-001 | Supplementary Gear Requirements | OPEN | 100 |
