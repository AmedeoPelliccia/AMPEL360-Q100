# LC01 — Problem Statement: Extension and Retraction

**ATA Reference:** 32-30  
**OPT-IN Axis:** T-TECHNOLOGIES  
**Parent System:** ATA 32 — Landing Gear  
**Scope:** Extension and Retraction requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Extension and Retraction** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-32-30-001 | Extension and Retraction Requirements | OPEN | 100 |
