# LC01 — Problem Statement: Main Gear and Doors

**ATA Reference:** 32-10  
**OPT-IN Axis:** T-TECHNOLOGIES  
**Parent System:** ATA 32 — Landing Gear  
**Scope:** Main Gear and Doors requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Main Gear and Doors** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-32-10-001 | Main Gear and Doors Requirements | OPEN | 100 |
