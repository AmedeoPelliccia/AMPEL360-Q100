# LC01 — Problem Statement: Position and Warning

**ATA Reference:** 32-60  
**OPT-IN Axis:** T-TECHNOLOGIES  
**Parent System:** ATA 32 — Landing Gear  
**Scope:** Position and Warning requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Position and Warning** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-32-60-001 | Position and Warning Requirements | OPEN | 100 |
