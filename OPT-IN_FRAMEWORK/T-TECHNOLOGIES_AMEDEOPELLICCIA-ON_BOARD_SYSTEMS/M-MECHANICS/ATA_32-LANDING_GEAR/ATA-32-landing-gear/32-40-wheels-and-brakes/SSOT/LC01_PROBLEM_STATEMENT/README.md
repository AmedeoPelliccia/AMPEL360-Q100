# LC01 — Problem Statement: Wheels and Brakes

**ATA Reference:** 32-40  
**OPT-IN Axis:** T-TECHNOLOGIES  
**Parent System:** ATA 32 — Landing Gear  
**Scope:** Wheels and Brakes requirements and governance

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Wheels and Brakes** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-32-40-001 | Wheels and Brakes Requirements | OPEN | 100 |
