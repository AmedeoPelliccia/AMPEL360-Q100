# LC01 — Problem Statement: Storage
...
This LC01 node orchestrates uncertainty resolution for **Storage** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-28-10-001 | Storage Requirements | OPEN | 100 |
