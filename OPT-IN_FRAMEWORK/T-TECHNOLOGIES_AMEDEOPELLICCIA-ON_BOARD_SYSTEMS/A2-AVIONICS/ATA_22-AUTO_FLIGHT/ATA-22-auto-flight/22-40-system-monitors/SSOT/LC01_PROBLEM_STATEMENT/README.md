# LC01 — Problem Statement: System Monitors

**ATA Reference:** 22-40  
**OPT-IN Axis:** T-TECHNOLOGIES / A2-AVIONICS  
**Parent System:** ATA 22 — Auto Flight  
**Scope:** System Monitors

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **System Monitors** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-22-40-001 | System Monitors Requirements | OPEN | 100 |
