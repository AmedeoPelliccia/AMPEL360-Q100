# LC01 — Problem Statement: Auto Throttle
...
This LC01 node orchestrates uncertainty resolution for **Auto Throttle** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-22-30-001 | Auto Throttle Requirements | OPEN | 100 |
