# LC01 — Problem Statement: Autopilot
...
This LC01 node orchestrates uncertainty resolution for **Autopilot** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-22-10-001 | Autopilot Requirements | OPEN | 100 |
