# LC01 — Problem Statement: Flight Deck Information Systems

**ATA Reference:** 46-20  
**OPT-IN Axis:** T-TECHNOLOGIES / I-INFORMATION  
**Parent System:** ATA 46 — Information Systems  
**Scope:** Flight Deck Information Systems

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Flight Deck Information Systems** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-46-20-001 | Flight Deck Information Systems Requirements | OPEN | 100 |
