# LC01 — Problem Statement: Dependent Position Determining

**ATA Reference:** 34-50  
**OPT-IN Axis:** T-TECHNOLOGIES / L2-LINKS  
**Parent System:** ATA 34 — Navigation  
**Scope:** Dependent Position Determining

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Dependent Position Determining** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-34-50-001 | Dependent Position Determining Requirements | OPEN | 100 |
