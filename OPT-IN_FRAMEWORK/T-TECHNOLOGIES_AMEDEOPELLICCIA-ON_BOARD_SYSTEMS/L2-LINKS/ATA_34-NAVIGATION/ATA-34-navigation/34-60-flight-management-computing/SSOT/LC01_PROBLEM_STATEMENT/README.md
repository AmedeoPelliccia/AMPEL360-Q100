# LC01 — Problem Statement: Flight Management Computing

**ATA Reference:** 34-60  
**OPT-IN Axis:** T-TECHNOLOGIES / L2-LINKS  
**Parent System:** ATA 34 — Navigation  
**Scope:** Flight Management Computing

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Flight Management Computing** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-34-60-001 | Flight Management Computing Requirements | OPEN | 100 |
