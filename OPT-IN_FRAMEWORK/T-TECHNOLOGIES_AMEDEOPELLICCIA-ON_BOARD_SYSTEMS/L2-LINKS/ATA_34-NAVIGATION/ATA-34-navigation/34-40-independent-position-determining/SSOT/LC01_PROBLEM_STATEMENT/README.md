# LC01 — Problem Statement: Independent Position Determining

**ATA Reference:** 34-40  
**OPT-IN Axis:** T-TECHNOLOGIES / L2-LINKS  
**Parent System:** ATA 34 — Navigation  
**Scope:** Independent Position Determining

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Independent Position Determining** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-34-40-001 | Independent Position Determining Requirements | OPEN | 100 |
