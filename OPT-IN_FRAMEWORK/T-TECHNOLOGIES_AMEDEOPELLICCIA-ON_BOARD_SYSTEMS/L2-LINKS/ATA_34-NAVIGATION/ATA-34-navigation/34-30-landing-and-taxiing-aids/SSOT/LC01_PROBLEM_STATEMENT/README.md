# LC01 — Problem Statement: Landing And Taxiing Aids

**ATA Reference:** 34-30  
**OPT-IN Axis:** T-TECHNOLOGIES / L2-LINKS  
**Parent System:** ATA 34 — Navigation  
**Scope:** Landing And Taxiing Aids

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Landing And Taxiing Aids** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-34-30-001 | Landing And Taxiing Aids Requirements | OPEN | 100 |
