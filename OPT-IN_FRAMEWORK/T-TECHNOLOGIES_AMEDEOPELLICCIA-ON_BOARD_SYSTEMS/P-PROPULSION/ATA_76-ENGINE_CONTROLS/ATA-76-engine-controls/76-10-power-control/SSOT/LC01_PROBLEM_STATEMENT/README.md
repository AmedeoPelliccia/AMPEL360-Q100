# LC01 — Problem Statement: Power Control
...
This LC01 node orchestrates uncertainty resolution for **Power Control** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-76-10-001 | Power Control Requirements | OPEN | 100 |
