# LC01 — Problem Statement: Air Inlet Section

**ATA Reference:** 72-20  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 72 — Engine  
**Scope:** Air Inlet Section

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Air Inlet Section** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-72-20-001 | Air Inlet Section Requirements | OPEN | 100 |
