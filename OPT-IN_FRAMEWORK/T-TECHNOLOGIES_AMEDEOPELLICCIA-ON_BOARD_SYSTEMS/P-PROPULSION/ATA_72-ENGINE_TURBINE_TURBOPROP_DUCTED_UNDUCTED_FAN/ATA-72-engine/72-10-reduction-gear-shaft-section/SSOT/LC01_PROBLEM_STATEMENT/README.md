# LC01 — Problem Statement: Reduction Gear Shaft Section

**ATA Reference:** 72-10  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 72 — Engine  
**Scope:** Reduction Gear Shaft Section

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Reduction Gear Shaft Section** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-72-10-001 | Reduction Gear Shaft Section Requirements | OPEN | 100 |
