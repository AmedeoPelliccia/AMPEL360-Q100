# LC01 — Problem Statement: Propulsor Section Rear Mounted

**ATA Reference:** 72-80  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 72 — Engine  
**Scope:** Propulsor Section Rear Mounted

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Propulsor Section Rear Mounted** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-72-80-001 | Propulsor Section Rear Mounted Requirements | OPEN | 100 |
