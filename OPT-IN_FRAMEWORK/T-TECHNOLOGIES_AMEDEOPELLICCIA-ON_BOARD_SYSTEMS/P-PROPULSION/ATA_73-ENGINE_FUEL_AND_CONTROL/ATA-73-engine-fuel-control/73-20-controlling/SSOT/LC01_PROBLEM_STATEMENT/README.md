# LC01 — Problem Statement: Controlling
...
This LC01 node orchestrates uncertainty resolution for **Controlling** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-73-20-001 | Controlling Requirements | OPEN | 100 |
