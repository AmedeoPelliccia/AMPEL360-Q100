# LC01 — Problem Statement: Switching
...
This LC01 node orchestrates uncertainty resolution for **Switching** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-74-30-001 | Switching Requirements | OPEN | 100 |
