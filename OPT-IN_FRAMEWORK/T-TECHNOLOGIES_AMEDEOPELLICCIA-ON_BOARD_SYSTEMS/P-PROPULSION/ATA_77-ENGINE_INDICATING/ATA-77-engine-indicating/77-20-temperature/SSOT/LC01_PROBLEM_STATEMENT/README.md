# LC01 — Problem Statement: Temperature
...
This LC01 node orchestrates uncertainty resolution for **Temperature** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-77-20-001 | Temperature Requirements | OPEN | 100 |
