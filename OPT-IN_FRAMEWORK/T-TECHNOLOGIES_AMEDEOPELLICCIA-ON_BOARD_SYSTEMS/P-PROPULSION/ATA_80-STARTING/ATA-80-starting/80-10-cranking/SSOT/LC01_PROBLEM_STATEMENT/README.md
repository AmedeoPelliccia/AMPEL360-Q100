# LC01 — Problem Statement: Cranking
...
This LC01 node orchestrates uncertainty resolution for **Cranking** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-80-10-001 | Cranking Requirements | OPEN | 100 |
