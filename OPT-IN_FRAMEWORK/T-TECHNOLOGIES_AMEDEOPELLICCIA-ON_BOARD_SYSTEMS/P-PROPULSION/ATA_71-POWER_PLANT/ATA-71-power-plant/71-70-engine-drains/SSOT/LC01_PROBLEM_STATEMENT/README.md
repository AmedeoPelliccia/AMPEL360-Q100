# LC01 — Problem Statement: Engine Drains
...
This LC01 node orchestrates uncertainty resolution for **Engine Drains** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-71-70-001 | Engine Drains Requirements | OPEN | 100 |
