# LC01 — Problem Statement: Attach Fittings

**ATA Reference:** 71-40  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 71 — Power Plant  
**Scope:** Attach Fittings

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Attach Fittings** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-71-40-001 | Attach Fittings Requirements | OPEN | 100 |
