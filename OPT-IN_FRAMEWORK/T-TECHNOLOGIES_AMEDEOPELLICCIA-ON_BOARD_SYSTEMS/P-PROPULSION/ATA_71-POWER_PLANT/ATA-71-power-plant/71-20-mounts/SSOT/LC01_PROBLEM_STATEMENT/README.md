...
This LC01 node orchestrates uncertainty resolution for **Mounts** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-71-20-001 | Mounts Requirements | OPEN | 100 |
