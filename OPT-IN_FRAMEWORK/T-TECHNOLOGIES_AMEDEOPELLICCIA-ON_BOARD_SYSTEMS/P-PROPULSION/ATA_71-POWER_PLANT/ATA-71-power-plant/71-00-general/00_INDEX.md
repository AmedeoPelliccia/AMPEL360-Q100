# 00_INDEX — ATA 71-00 Power Plant
...
This index provides a comprehensive view of all artifacts in the triple knowledge-base spine for ATA 71 (Power Plant).
...
|---------|-------|--------|-------|-----------------|
| KNOT-71-00-001 | Power Plant System Baseline | PLANNING | STK_SE | 10% |
...
|-----------|-------|---------|--------|
| O-KNOT-71-00-001 | Power Plant Knowledge Gap | heritage | ACTIVE |
...
|-----------|-------|----------|--------|
| Y-KNOT-71-00-001-001 | Power Plant Resolution Approach | OPT-001 | JUSTIFIED |
...
|-------------|-------|--------|---------------|
| DEC-71-00-001 | Power Plant Baseline Architecture | PROPOSED | — |
...
|----------------|-------|--------|----------------|
| TS-71-00-001 | Power Plant Architecture Trade Study | OPEN | — |
...
|--------|------|-------|-----|------|--------|
| KNU-71-00-001-REQ-001 | KNOT-71-00-001 | Power Plant Requirements | LC02 | REQ | PLANNED |
...
|-----|-------|-----------|--------|
| DMC-AMPEL360-71-00-00-00A-001A-A | Power Plant System Description | 001 | PLANNED |
...
```
O-KNOT-71-00-001 → Y-KNOT-71-00-001-001 → KNOT-71-00-001
                                                                                 ↓
                                                              KNU-71-00-001-REQ-001 (LC02)
```

### 4.2 SSOT → PUBS Links

```
KNU-71-00-001-PUB-001 → DMC-AMPEL360-71-00-00-00A-001A-A
```
