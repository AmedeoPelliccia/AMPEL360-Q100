# LC01 — Problem Statement: Engine Anti Icing

**ATA Reference:** 75-10  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 75 — Air  
**Scope:** Engine Anti Icing

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Engine Anti Icing** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-75-10-001 | Engine Anti Icing Requirements | OPEN | 100 |
