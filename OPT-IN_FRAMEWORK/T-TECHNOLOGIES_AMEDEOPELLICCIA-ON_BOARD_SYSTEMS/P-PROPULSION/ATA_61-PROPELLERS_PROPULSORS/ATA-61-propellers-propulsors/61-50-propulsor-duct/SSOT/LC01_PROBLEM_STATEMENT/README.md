# LC01 — Problem Statement: Propulsor Duct

**ATA Reference:** 61-50  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 61 — Propellers/Propulsors  
**Scope:** Propulsor Duct

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Propulsor Duct** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-61-50-001 | Propulsor Duct Requirements | OPEN | 100 |
