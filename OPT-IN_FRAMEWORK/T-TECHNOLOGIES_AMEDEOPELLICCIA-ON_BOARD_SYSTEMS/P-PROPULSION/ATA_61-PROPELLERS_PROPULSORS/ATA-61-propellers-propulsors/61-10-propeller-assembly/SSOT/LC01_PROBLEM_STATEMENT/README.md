# LC01 — Problem Statement: Propeller Assembly

**ATA Reference:** 61-10  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 61 — Propellers/Propulsors  
**Scope:** Propeller Assembly

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Propeller Assembly** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-61-10-001 | Propeller Assembly Requirements | OPEN | 100 |
