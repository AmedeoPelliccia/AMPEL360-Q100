# LC01 — Problem Statement: Noise Suppressor

**ATA Reference:** 78-20  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 78 — Exhaust  
**Scope:** Noise Suppressor

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Noise Suppressor** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-78-20-001 | Noise Suppressor Requirements | OPEN | 100 |
