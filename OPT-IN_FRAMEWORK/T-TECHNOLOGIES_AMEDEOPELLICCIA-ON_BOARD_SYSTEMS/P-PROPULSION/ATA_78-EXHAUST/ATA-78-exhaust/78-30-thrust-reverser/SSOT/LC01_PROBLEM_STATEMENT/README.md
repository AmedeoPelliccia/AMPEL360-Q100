# LC01 — Problem Statement: Thrust Reverser

**ATA Reference:** 78-30  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 78 — Exhaust  
**Scope:** Thrust Reverser

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Thrust Reverser** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-78-30-001 | Thrust Reverser Requirements | OPEN | 100 |
