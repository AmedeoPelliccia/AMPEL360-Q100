# LC01 — Problem Statement: Collector Nozzle

**ATA Reference:** 78-10  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 78 — Exhaust  
**Scope:** Collector Nozzle

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Collector Nozzle** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-78-10-001 | Collector Nozzle Requirements | OPEN | 100 |
