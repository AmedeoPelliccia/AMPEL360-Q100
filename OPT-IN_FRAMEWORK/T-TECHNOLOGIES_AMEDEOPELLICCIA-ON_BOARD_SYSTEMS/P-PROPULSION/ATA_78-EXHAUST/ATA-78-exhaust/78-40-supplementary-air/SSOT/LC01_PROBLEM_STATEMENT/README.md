# LC01 — Problem Statement: Supplementary Air

**ATA Reference:** 78-40  
**OPT-IN Axis:** T-TECHNOLOGIES / P-PROPULSION  
**Parent System:** ATA 78 — Exhaust  
**Scope:** Supplementary Air

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Supplementary Air** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-78-40-001 | Supplementary Air Requirements | OPEN | 100 |
