...
This index provides a comprehensive view of all artifacts in the triple knowledge-base spine for ATA 95 (AI/ML).
...
|---------|-------|--------|-------|-----------------|
| KNOT-95-00-001 | AI/ML System Baseline | PLANNING | STK_SE | 10% |
...
|-----------|-------|---------|--------|
| O-KNOT-95-00-001 | AI/ML Knowledge Gap | heritage | ACTIVE |
...
|-----------|-------|----------|--------|
| Y-KNOT-95-00-001-001 | AI/ML Resolution Approach | OPT-001 | JUSTIFIED |
...
|-------------|-------|--------|---------------|
| DEC-95-00-001 | AI/ML Baseline Architecture | PROPOSED | — |
...
|----------------|-------|--------|----------------|
| TS-95-00-001 | AI/ML Architecture Trade Study | OPEN | — |
...
|--------|------|-------|-----|------|--------|
| KNU-95-00-001-REQ-001 | KNOT-95-00-001 | AI/ML Requirements | LC02 | REQ | PLANNED |
...
|-----|-------|-----------|--------|
| DMC-AMPEL360-95-00-00-00A-001A-A | AI/ML System Description | 001 | PLANNED |
...
```
O-KNOT-95-00-001 → Y-KNOT-95-00-001-001 → KNOT-95-00-001
                                                                                 ↓
                                                              KNU-95-00-001-REQ-001 (LC02)
```

### 4.2 SSOT → PUBS Links

```
KNU-95-00-001-PUB-001 → DMC-AMPEL360-95-00-00-00A-001A-A
```
