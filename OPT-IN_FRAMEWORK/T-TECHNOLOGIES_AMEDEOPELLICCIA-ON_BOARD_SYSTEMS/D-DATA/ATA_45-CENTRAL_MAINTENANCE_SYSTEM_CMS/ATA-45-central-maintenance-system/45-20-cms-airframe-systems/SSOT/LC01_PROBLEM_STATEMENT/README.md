# LC01 — Problem Statement: Cms Airframe Systems

**ATA Reference:** 45-20  
**OPT-IN Axis:** T-TECHNOLOGIES / D-DATA  
**Parent System:** ATA 45 — Central Maintenance System  
**Scope:** Cms Airframe Systems

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Cms Airframe Systems** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-45-20-001 | Cms Airframe Systems Requirements | OPEN | 100 |
