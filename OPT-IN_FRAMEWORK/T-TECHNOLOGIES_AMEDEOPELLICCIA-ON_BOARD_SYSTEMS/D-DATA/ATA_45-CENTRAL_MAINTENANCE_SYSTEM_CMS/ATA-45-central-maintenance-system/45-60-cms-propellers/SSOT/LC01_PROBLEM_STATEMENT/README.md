# LC01 — Problem Statement: Cms Propellers

**ATA Reference:** 45-60  
**OPT-IN Axis:** T-TECHNOLOGIES / D-DATA  
**Parent System:** ATA 45 — Central Maintenance System  
**Scope:** Cms Propellers

---

## 1. Overview

This LC01 node orchestrates uncertainty resolution for **Cms Propellers** within the AMPEL360 Q100 BWB hydrogen-hybrid aircraft program.
...
|---------|-------|--------|----------|
| KNOT-45-60-001 | Cms Propellers Requirements | OPEN | 100 |
